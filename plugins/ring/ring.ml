...
let zdir = ["Coq"; plugin_dir; "Z"]
let qdir = ["Coq"; plugin_dir; "Q"]
let plugin_modules =
...
let znew_ring_path =
  DirPath.make (List.map Id.of_string ["InitialRing";"Z";plugin_dir;"Coq"])
let zltac s =
...
let pol_cst s = mk_cst [plugin_dir;"Z";"Ring_polynom"] s
...
let new_field_path =
  DirPath.make (List.map Id.of_string ["Field_tac";"Q";plugin_dir;"Coq"])
