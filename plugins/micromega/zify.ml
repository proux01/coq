...
let zify_tac =
  Proofview.Goal.enter (fun gl ->
      Coqlib.check_required_library ["Stdlib"; "micromega"; "Zify"; "Stdlib"; "micromega"; "ZifyClasses"];
      Coqlib.check_required_library ["Stdlib"; "micromega"; "Zify"; "Stdlib"; "micromega"; "ZifyInst"];
      init_cache ();
      let evd = Tacmach.project gl in
      let env = Tacmach.pf_env gl in
      let sign = Environ.named_context env in
